  ...
  return (
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-xl font-bold mb-4 flex items-center">
              <span className="text-[#ff4c00]">Roar</span>Media
            </h3>
            <p className="text-gray-400 mb-4">
              Creating explosive social media content that converts.
              From auto to apparel, we build your brand presence where
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          <p>© 2024 RoarMedia. All rights reserved.</p>
